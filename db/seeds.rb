...
@user1 = User.create(username:"user1", age:27)
@user2 = User.create(username:"user2", age:58)
@user3 = User.create(username:"user3", age:42 )
@user4 = User.create(username:"user4", age:31 )
